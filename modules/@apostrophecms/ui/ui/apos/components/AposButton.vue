<template>
  ...
  >
    ...
    >
      ...
      <span v-if="colorStyle" class="apos-button__color-preview">
...
.apos-button {
  ...
  .apos-spinner.fade-enter-active,
  .fade-leave-active {
    transition: all 0.2s ease;
  }

  .apos-spinner.fade-enter,
  .fade-leave-to {
    opacity: 0;
  }
}
...
.apos-button--primary {
  ...
  &:focus {
    box-shadow: 0 0 0 1px var(--a-base-7), 0 0 0 3px var(--a-primary-light-40);
  }
  &[disabled],
  &.apos-button--disabled {
